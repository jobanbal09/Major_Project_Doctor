...
namespace Major_Project_Doctor.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public PatientsController(Major_Project_DoctorContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Patient_Name,Address,Patient_Age,Joining_Date")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
