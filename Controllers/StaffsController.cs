...
namespace Major_Project_Doctor.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public StaffsController(Major_Project_DoctorContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Staff_Name,Department,Staff_Contact")] Staff staff)
        {
            if (id != staff.Id)
            {
                return NotFound();
