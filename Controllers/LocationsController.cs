...
namespace Major_Project_Doctor.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(Major_Project_DoctorContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name_of_clinic,Address,Contact")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
